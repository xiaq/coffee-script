...
(function() {
  ...
  my_exists = fs.exists || path.exists;
  ...
  BANNER = 'Usage: iced [options] path/to/script.coffee -- [args]\n\nIf called without options, `coffee` will run your script.';
  ...
  removeSource = function(source, base, removeJs) {
    ...
    if (removeJs && !opts.join) {
      ...
      return my_exists(jsPath, function(exists) {
        if (exists) {
  ...
  writeJs = function(source, js, base) {
    ...
    return my_exists(jsDir, function(exists) {
      if (exists) {
        return compile();
      } else {
