(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.tameGo = function() {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        child = _ref2[_i];
        if ((child instanceof Await || child instanceof Defer) || child.tameGo()) {
          return true;
        }
      }
      return false;
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.tameWrap = function(d) {
      var body, break_assign, break_id, cond, condition, continue_assign, continue_block, continue_body, continue_id, k_id, outStatements, top_assign, top_block, top_body, top_call, top_func, top_id, top_statements;
  ...
  exports.TameRequire = TameRequire = (function(_super) {
    ...
    TameRequire.prototype.compileNode = function(o) {
      var access, call, callv, file, inc, k, lhs, ns, out, req, rhs, v;
      this.tab = o.indent;
      ...
      inc = (function() {
        switch (v) {
          case "inline":
            return InlineDeferral.generate();
          case "node":
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileTame = function(o, d) {
      var a1, a2, a3, a4, a5, b, body, condition, empty_arr, init, ival, key, key_lit, key_val, keys, keys_access, keys_len, keys_val, len, len_rhs, len_val, loop_body, loop_keys, loop_source, ref, ref_val, ref_val_copy, scope, source_access, step;
      if (!this.tameNodeFlag) return null;
      body = d.body;
      condition = null;
      init = [];
