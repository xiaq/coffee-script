// Generated by IcedCoffeeScript 1.3.3c
(function() {
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileIced = function(o, d) {
      var a1, a2, a3, a4, a5, b, body, condition, empty_arr, guard, iname, init, ival, key, key_lit, key_val, keys, keys_access, keys_len, keys_val, kval, len, len_rhs, len_val, loop_body, loop_keys, loop_source, ref, ref_val, ref_val_copy, rop, rvar, scope, source_access, step;
      if (!this.icedNodeFlag) return null;
      body = d.body;
      condition = null;
      init = [];
