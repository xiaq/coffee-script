...
(function() {
  ...
  exports.Defer = Defer = (function(_super) {
    ...
    Defer.prototype.newDeferParam = function() {
      var l;
      l = "" + iced["const"].defer_arg + (this.deferParams.length + 1);
      return this.deferParams.push(new Param(new Literal(l)));
    };
    ...
    Defer.prototype.makeAssignFn = function(o) {
      ...
      inner_fn = new Code(this.deferParams, block, 'icedgen');
