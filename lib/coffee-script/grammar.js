...
(function() {
  ...
  grammar = {
    ...
    Code: [
      o('PARAM_START ParamList PARAM_END OptAsync FuncGlyph Block', function() {
        return new Code($2, $6, $5, $4);
      }), o('ASYNC FuncGlyph Block', function() {
        return new Code([], $3, $2, true);
      }), o('FuncGlyph Block', function() {
        return new Code([], $2, $1, false);
      })
    ],
    OptAsync: [
      o('', function() {
